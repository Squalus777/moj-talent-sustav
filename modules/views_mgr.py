...
def render_manager_view():
    ...
    # 3. UNOS PROCJENA
        ...
        for _, emp in my_team.iterrows():
            ...
            # Naslov expandera
            status_txt = "Završeno" if is_locked else "U tijeku" if r else "Nije započeto"
            ...
            with st.expander(f"{'🔒' if is_locked else '✏️'} {emp['ime_prezime']} ({status_txt})"):
                ...
                if not s_eval.empty:
                    ...
                    # POPRAVAK: Ovdje koristimo m['title'], a ne m['label']
                ...
                if is_locked and r is not None:
                    ...
                    if st.button("🖨️ PDF", key=f"pdf_{kid}"):
                        # POPRAVAK: PDF generiranje s m['title']
                    ...
                    with st.form(f"eval_form_{kid}"):
                        ...
                        with c1: 
                            st.subheader("Učinak")
                            # Koristi vizualnu funkciju iz utils.py
